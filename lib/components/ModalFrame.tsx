  ...
  return createElement(
    ...
    createElement(
      "div",
      {
        ...
        className: `modals-frame ${item.phase === "exiting" ? "modals-frame-exit" : ""} ${!isTop ? "modals-frame-dim" : ""} ${item.className ?? ""}`.trim(),
        style: sizeStyle,
      ...
      item.footer &&
        createElement(
          ...
          createElement(item.footer.component, item.footer.props ?? {})
        )
    )
  );
}
